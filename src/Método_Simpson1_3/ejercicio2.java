...
public class ejercicio2 {
    ...
    public class ApproximatePiAndDifferentiationSimpson {
        ...
        public static void main(String[] args) {
            Function<Double, Double> func = Math::exp; // Función: e^x
            ...
            System.out.println("Integral de e^x desde 0 a 1: " + integralResult);

            double derivative = differentiate(x0, h, func);
            System.out.println("Derivada de e^x en x = " + x0 + ": " + derivative);
        }
    }
}